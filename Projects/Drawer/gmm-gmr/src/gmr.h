...
class GaussianMixture {
 ...
 public :
  ...
  Matrix speedCompute(Matrix inData);
    /* Calcule les vitesses en fonction du temps à partir 
		des positions d'entrée */

  Matrix speedPosition(Matrix inData, Matrix speedData);
      /* retourne une matrice contenant dans les n premieres 
		 colonnes les vecteurs postions pour les n moteurs et
		 dans les vitesses dans les n dernieres colonnes */
  Matrix getPosition(Matrix outpout, Vector posInit);
        /* traduit les vitesses de la matrice outpout en
		   position à partir d'une position initiale */
